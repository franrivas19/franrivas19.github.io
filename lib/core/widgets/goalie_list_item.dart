...
class _GoalieListItemState extends State<GoalieListItem>
                        ...
                        BoxShadow(
                          color: (isTopThree
                              ...
                              .withValues(
                                alpha:
                                    0.15 +
                                    (0.1 * _elevationAnimation.value / 8),
                              ),
                          blurRadius: 10 + (4 * _elevationAnimation.value / 8),
                          offset: Offset(
                            0,
                            4 + (4 * _elevationAnimation.value / 8),
                          ),
                        ),
                      ],
                    ),
                    child: ListTile(
                            ...
                            BoxShadow(
                              color: (isTopThree
                                  ...
                                  .withValues(
                                    alpha:
                                        0.4 +
                                        (0.2 * _elevationAnimation.value / 8),
                                  ),
                              blurRadius:
                                  8 + (4 * _elevationAnimation.value / 8),
                            ),
                          ],
                        ),
                        child: Center(
                      ...
                      subtitle: Text(
                        ...
                        style: TextStyle(
                          fontSize: 13,
                          color:
                              isTopThree ? Colors.white70 : AppTheme.accentGrey,
